/**
 * codec.js — Adaptive frame decoder for Rasterift.
 *
 * Mirrors codec.py. Runs in the browser (attaches window.RasteriftCodec) and in
  ...
  function makeDecoder(cellBytes) {
    ...
    async function decode(message) {
      ...
      if (tag === TAG_RAW) {
        ...
        throw new Error('Unknown Rasterift codec tag: ' + tag);
      }
      prev = frame;
